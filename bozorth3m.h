...
class BOZORTH3MSHARED_EXPORT Bozorth3_Core
{
...
public:
    ...
    struct xyt_struct * bz_load(const MINUTIAE_VECTOR &minutiae, bool useQuality);
...
// struct representing one fingerprint match
typedef struct _FINGERPRINT_PAIR{
...
class BOZORTH3MSHARED_EXPORT BozorthMultiThreadManager : public QObject
{
    Q_OBJECT
public:
...
class BOZORTH3MSHARED_EXPORT BozorthThread : public QObject
{
    Q_OBJECT
public:
    explicit BozorthThread(QObject *parent = nullptr);
    BozorthThread(QMap<QString,MINUTIAE_VECTOR> _minDataAll, FINGERPRINT_PAIRS _thread_fingerprint_pairs);
...
private:
    ...
    QMap<QString,MINUTIAE_VECTOR> minDataAll;
